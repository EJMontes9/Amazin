...
export class ProductFilterComponent implements OnInit {
  ropas: ProductListInterface[]  = [];
  //ropaCopy: ProductListInterface[] = [];

  //dataSource: any = []

  constructor(public http: HttpClient, private service: ProductListService) {
  ...
  private getData(): void {
    this.service.getProductList().pipe(take(1)).subscribe((res: any) => {
      this.ropas = [...this.ropas, ...res];
